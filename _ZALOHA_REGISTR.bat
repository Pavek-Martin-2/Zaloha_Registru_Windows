...
REM tady napriklad -  set cesta=C:\Users\DELL\Documents\zaloha\
...
rar a -rr10p -m5 "C:\Users\DELL\Documents\zaloha\%file_rar%" "C:\Users\DELL\Documents\zaloha\%file_reg%"
